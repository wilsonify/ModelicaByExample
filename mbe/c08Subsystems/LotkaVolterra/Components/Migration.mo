...
model Migration "Simple 'diffusion' based model of migration"
  ...
  mbe.c07Components.LotkaVolterra.Interfaces.Species rabbit_a
    "Rabbit population in Region A"
    annotation (Placement(transformation(extent={{-70,90},{-50,110}})));
  mbe.c07Components.LotkaVolterra.Interfaces.Species rabbit_b
    "Rabbit population in Region B"
    annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
  mbe.c07Components.LotkaVolterra.Interfaces.Species fox_a
    "Fox population in Region A"
    annotation (Placement(transformation(extent={{50,90},{70,110}})));
  mbe.c07Components.LotkaVolterra.Interfaces.Species fox_b
...
equation
  ...
  annotation ( Icon(graphics={
        ...
        Bitmap(extent={{-84,82},{-36,-82}}, fileName=
              "modelica://mbe/Resources/Images/rabbit.png"),
        Bitmap(extent={{18,80},{94,-84}}, fileName=
              "modelica://mbe/Resources/Images/fox.png")}));
end Migration;
