within IC;
package ConstantsAndParameters "Contains constants and fabrication parameters for different components"
    extends Modelica.Icons.Library2;
    import SI = Modelica.SIunits;
    package ResistanceConstants "Contains constants and parameters for resistance"
      final constant SI.Resistance Rs = 50 "Sheet resistance of the resistor material";
    end ResistanceConstants;
    package CapacitorConstants "Contains constants and parameters for capacitor"
      ...
      final constant SI.Distance t = 500 "Separation of capacitor metal plates in Armstrongs";
